    ...
    <div className="min-h-screen flex flex-col">
      ...
      <section className="relative flex-1 flex items-center justify-center min-h-screen overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-2xl mx-auto animate-fade-in">
          <div className="inline-flex items-center gap-2 mb-8 px-4 py-2 rounded-full border border-border/60 bg-card/60 backdrop-blur-sm">
            ...
            <span className="text-sm text-muted-foreground font-medium">A new kind of social</span>
          </div>
      ...
      <section className="py-24 px-6">
        <div className="max-w-4xl mx-auto grid sm:grid-cols-3 gap-8">
          {[
            { title: "Express", desc: "Share thoughts as text, images, or videos — your way." },
            { title: "Connect", desc: "Find like-minded souls in a calmer, more thoughtful space." },
            { title: "Reflect", desc: "A feed designed to slow you down, not speed you up." },
          ].map((item, i) => (
            <div
              key={item.title}
